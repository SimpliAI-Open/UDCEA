...
def get_info_struct_att(align_list, choice):
    ...
    if choice=="att_rel":
        ...
        np.save("../multi-view information/zh_en/zh_att_rel.npy", zh_att_rel)
        np.save("../multi-view information/zh_en/en_att_rel.npy", en_att_rel)
        return zh_att_rel, en_att_rel

    if choice=="att_tar":
        zh_att_tar, en_att_tar=get_str_att_info("att", "tar")
        np.save("../multi-view information/zh_en/zh_att_tar.npy", zh_att_tar)
        np.save("../multi-view information/zh_en/en_att_tar.npy", en_att_tar)
        return zh_att_tar, en_att_tar

    if choice=="str_tar":
        zh_str_tar, en_str_tar=get_str_att_info("str", "tar")
        np.save("../multi-view information/zh_en/zh_str_tar.npy", zh_str_tar)
        np.save("../multi-view information/zh_en/en_str_tar.npy", en_str_tar)
...
if __name__=="__main__":
    ...
    for infor_name in ["str_tar", "att_rel", "att_tar"]:
        print(infor_name+":")
        zh_vec_dict = gener_att_str_info_vector(np.load("../multi-view information/zh_en/zh_"+infor_name+".npy", allow_pickle=True),
                                                "../translate files/zh_en/zh_"+infor_name+"_trans.txt", "zh", model)
        en_vec_dict = gener_att_str_info_vector(np.load("../multi-view information/zh_en/en_"+infor_name+".npy", allow_pickle=True), "", "en", model)
